...
const meta = {
  ...
  component: Skeleton,
  // Skeletons always render inside a panel or card in the app, so stories
  // present them on bg-surface — on the page background, sunken-on-page is
  // (correctly) almost invisible.
  decorators: [
    (Story) => (
